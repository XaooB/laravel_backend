...
class PollTable extends Component {
  ...
  render() {
    return (
      <div>
      TODO:
    <p>  - dodawanie/modyfikacja/usuwanie ankiet, </p>
    <p> - wyszukiwanie ankiet</p>
    <p>  - lista wszystkich ankiet,</p>
    <p>  - statystyki dla poszczególnych ankiet</p>
      </div>
    );
  };
};
...
export default withRouter(connect(mapStateToProps, { searchAdminArticles })(PollTable));
