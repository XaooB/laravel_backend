...
Route::group(['middleware' => 'apiresponse'], function() {
    ...
    Route::get('articles_show_neighbours/{id}/{count}', 'ArticlesController@show_neighbours')->name('articles.show_neighbours');
    // Comments routes
    ...
    Route::get('injuriessuspensions_actual_injuries', 'InjuriesSuspensionsController@actual_injuries')->name('injuriessuspensions.actual_injuries');
    // Players routes
