<?php
    ...
    class ArticlesController extends Controller
    {
        ...
        {
            if($request->cname != null && $_SESSION['name'] != null && $request->title != null && $request->content != null && $request->image != null)
            {
                $articles = new Articles;
                $articles->idCategory = DB::table('categories')->select('idCategory')->where('Name', '=', $request->cname)->value('idCategory');
                $articles->idUser = DB::table('users')->select('id')->where('Name', '=', $_SESSION['name'])->where('remember_token', '=', $_SESSION['token'])->value('id');
        ...
        public function update(Request $request, $id)
        {
            ...
            */
            if($request->cname != null && $_SESSION['name'] != null && $request->title != null && $request->content)
            {
                ...
                if(Articles::where('idArticle', '=' , $id)->where('Visible', '!=', 0)->update([
                    'idCategory' => DB::table('categories')->select('idCategory')->where('Name', '=', $request->cname)->value('idCategory'),
                    'idUser' => DB::table('users')->select('id')->where('Name', '=', $_SESSION['name'])->value('id'),
                    'Title' => $request->title,
